...
class LatestInfo(BaseModel):
    ...
    high: Optional[int] = Field(description="The latest high price transaction")
    high_time: Optional[int] = Field(description="The time of the latest high price transaction")
    low: Optional[int] = Field(description="The latest low price transaction")
    low_time: Optional[int] = Field(description="The time of the latest low price transaction")


class LatestPayload(BaseModel):
    data: Dict[int, LatestInfo] = Field(description="The latest price information for each item. The key is the item ID.")
...
class MappingInfo(BaseModel):
    ...
    members: bool = Field(description="Whether or not the item is members-only")
    name: str = Field(description="The item's name")
    lowalch: Optional[int] = Field(description="The item's low alchemy value")
    highalch: Optional[int] = Field(description="The item's high alchemy value")
